...
replace ehchf2 = . if per != 17 
replace ehcnj2 = . if per != 17
replace ehflh2 = . if per != 17
replace ehchf2 = . if entrevista != 2 & entrevista != 3 & entrevista != 4 
replace ehcnj2 = . if entrevista != 2 & entrevista != 3 & entrevista != 4
replace ehflh2 = . if entrevista != 2 & entrevista != 3 & entrevista != 4
...
replace chfvalido = . if inv == 1
replace cnjvalido = . if inv == 1
replace flhvalido = . if inv == 1

gen chfdes = 1 if chfvalido == 1 & (od==17|oi==17)
gen chfemp = 1 if chfvalido == 1 & (oo==17)	
